...
export default function LogoFakultas({label}){
    return(
        <div className="w-[1019px] flex flex-col gap-[12px] mb-10">
            {/* Untuk Judul Label */}
            <h4 className="text-[14px] font-semibold text-black leading-[20px] mb-6">
                {label}
            </h4>
