    ...
    <div className="min-h-screen bg-[#F0F7FF] flex flex-col items-center p-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-xl p-10 z-10 space-y-8">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-6">
            ...
            <div className="space-y-2">
              ...
              <select className="border border-gray-200 p-3 rounded-lg w-full text-gray-300 bg-gray-50"><option>Pilih universitas</option></select>
            </div>
            <div className="space-y-2">
              <label className="text-sm font-bold">Jabatan</label>
              <input type="text" placeholder="Jabatan di Organisasi" className="border border-gray-200 p-3 rounded-lg w-full bg-gray-50" />
            </div>
            {/* Row 2 */}
            <div className="space-y-2">
              <label className="text-sm font-bold">Email</label>
              <div className="flex border border-gray-200 rounded-lg overflow-hidden bg-gray-50">
                <input type="text" placeholder="Masukkan email" className="p-3 w-full bg-transparent outline-none" />
                <span className="p-3 text-gray-400 text-sm border-l bg-white">.helPhian@gmail.com</span>
              </div>
            </div>
            <div className="space-y-2">
              <label className="text-sm font-bold">Password</label>
              <input type="password" placeholder="Masukkan password" className="border border-gray-200 p-3 rounded-lg w-full bg-gray-50" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <select className="border border-gray-200 p-3 rounded-lg w-full text-gray-300 bg-gray-50"><option>Pilih fakultas</option></select>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end space-x-4 pt-6">
          <Link href="/tambah-admin" className="px-8 py-3 text-gray-400 font-semibold hover:text-gray-600 transition flex items-center">
            Batal
          </Link>
